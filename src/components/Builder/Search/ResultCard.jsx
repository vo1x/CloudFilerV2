function ResultCard({ title, description, type, releaseDate, thumbnail, ...rest }) {
  return (
    <div {...rest} className="flex max-w-96 gap-2 p-2 lg:hover:cursor-pointer lg:hover:bg-white/10">
