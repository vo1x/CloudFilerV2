...
function EmbedCode(props) {
  ...
  <span style="color: #000000;"><strong>${props.formData.quality === '2160p' ? '2160p and 1080p' : props.formData.quality} ${props.formData.printType} </strong></span>
  <span style="color: #0000ff;"><strong>[${props.formData.audioType === 'Single' ? props.formData.audioLanguages : props.formData.audioType} Audio]</strong></span></h2>
